    ...
    private void initTowers() {
        switch (type) {
            case top:
                ...
                towers.add(new Tower(0.25, 0.04, 1)); 
                towers.add(new Tower(0.50, 0.04, 1));  
                towers.add(new Tower(0.75, 0.04, 1));  
                break;

            case middle:
                towers.add(new Tower(0.20, 0.80, 0)); 
                towers.add(new Tower(0.30, 0.70, 0)); 
                towers.add(new Tower(0.40, 0.60, 0)); 
                towers.add(new Tower(0.60, 0.40, 1));  
                towers.add(new Tower(0.70, 0.30, 1));  
                towers.add(new Tower(0.80, 0.20, 1));  
                break;

            case bot:
                towers.add(new Tower(0.25, 0.95, 0)); 
                towers.add(new Tower(0.55, 0.95, 0)); 
                towers.add(new Tower(0.85, 0.95, 0)); 
