...
public class Minion extends Entity {
    ...
    public void update(double deltaTime, List<Entity> enemies, Player player) {
        if (!active) return;
        
        attackTimer -= deltaTime;
        Entity target = findTarget(enemies, player);
    ...
    private boolean isInRange(Entity target) {
        return( this.getDistanceTo(target) <= attackRange);
    }
